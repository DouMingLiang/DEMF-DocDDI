...
def load_data(root_Data):
    ...
    for i in range(total_line):
        ...
        for j in range(0, len(list_9)):
            ...
            drug_1_raw = drug_1_raw.lower()
            drug_2_raw = drug_2_raw.lower()
...
if __name__ == '__main__':
    ...
    setup_seed(90)
    file_1 = open('results/GLDoc_PPI.txt', 'w')
    file_name = 'AIMed_train_doc_FT.txt'
    pairs_num_max = 0
    ...
    # save model
    torch.save(model, "GLDoc_PPI.pth")

    # Test
    corrects, avg_loss = 0, 0
    corrects_test = 0
    sum_test = 0
    file_name = 'AIMed_test_doc_FT.txt'
    pairs_num_max_1 = 0
    ...
    loader = gen_dataloader()
    model = torch.load("GLDoc_PPI.pth")
    model.eval()
